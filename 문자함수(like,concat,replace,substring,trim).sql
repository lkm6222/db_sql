...
SELECT REPLACE('010-7890-1234', "-", " ");


/*본인 휴대전화번호의 가운데 4자리만 출력하시오.*/
SELECT SUBSTRING('010-7890-1234', 5, 4);


/*본인 휴대전화번호에서 010- 을 제외한 나머지 번호를 출력하시오*/
SELECT SUBSTRING('010-7890-1234', 5);
SELECT REPLACE('010-7890-1234', '010-', '');
...
SELECT 
CONCAT(
	LEFT('010-7890-1234', 3), "-", 
	SUBSTRING('010-7890-1234', 5, 4),"-", 
	RIGHT('010-7890-1234', 4)) AS RESULT;